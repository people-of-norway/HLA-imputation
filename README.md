...
- output_folder: the path to the folder where you want the intermediate pipeout files to be stored
- release_folder: the path to the folder where you want the final output files
